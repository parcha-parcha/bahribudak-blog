  ...
  return (
    <footer className="bg-navy text-white bb-pattern">
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="border-t border-white/10 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4"><p className="text-xs text-white/45">© {year} Bahri Budak. {t('footer.rights')}</p><div className="flex items-center gap-1"><div className="w-4 h-0.5 bg-yellow-bb" /><span className="text-xs text-white/45 px-2">bahribudak.com</span><div className="w-4 h-0.5 bg-yellow-bb" /></div></div>
      </div>
    </footer>
  )
}
