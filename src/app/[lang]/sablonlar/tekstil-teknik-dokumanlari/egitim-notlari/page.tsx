            ...
            return (
              ...
              >
                ...
                <dl className="mt-5 grid grid-cols-3 gap-3 rounded-2xl bg-[#F6F4EF] p-4 text-xs">
                  <div>
                    <dt className="font-semibold text-[#111315]/45">{t.version}</dt>
                    <dd className="mt-1 font-bold text-[#111315]">{resource.version}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-[#111315]/45">{t.fileSize}</dt>
                    <dd className="mt-1 font-bold text-[#111315]">{resource.size}</dd>
                  </div>
                  <div>
                    <dt className="font-semibold text-[#111315]/45">{t.fileLanguage}</dt>
