...
export default async function MembershipPage({
  ...
  return (
    <main className="min-h-screen bg-[#F6F4EF] px-4 py-10 text-[#111315] md:px-6 md:py-16">
      <section className="mx-auto max-w-6xl overflow-hidden rounded-[2.4rem] bg-[#111315] p-7 text-[#F6F4EF] shadow-[0_28px_80px_rgba(17,19,21,0.16)] md:p-12">
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href={registerHref}
            className="rounded-full bg-[#E45A2B] px-6 py-3 font-bold text-[#F6F4EF] transition hover:bg-[#C94E26]"
          >
            {copy.primary} →
          </Link>
          ...
          <Link
            href={loginHref}
            className="rounded-full border border-[#F6F4EF]/30 px-6 py-3 font-bold text-[#F6F4EF] transition hover:bg-[#F6F4EF] hover:text-[#111315]"
          >
            {copy.login}
          </Link>
        </div>
      ...
      <section className="mx-auto mt-8 grid max-w-6xl gap-5 md:grid-cols-2">
        {copy.benefits.map(([no, title, text]) => (
          <article
            key={no}
            className="rounded-[2rem] border border-[#E5E2DA] bg-white p-7 shadow-[0_14px_45px_rgba(17,19,21,0.06)]"
          >
      ...
      <section className="mx-auto mt-8 max-w-6xl rounded-[2rem] border border-[#E5E2DA] bg-[#E5E2DA] p-7 md:p-9">
        ...
        <div className="mt-6 flex flex-wrap gap-3">
          <Link
            href={resourcesHref}
            className="rounded-full bg-[#111315] px-6 py-3 font-bold text-[#F6F4EF] transition hover:bg-[#2A2E32]"
          >
            {copy.resources} →
          </Link>
          ...
          <Link
            href={contactHref}
            className="rounded-full border border-[#111315] px-6 py-3 font-bold text-[#111315] transition hover:bg-[#111315] hover:text-[#F6F4EF]"
          >
            {copy.support} →
          </Link>
        </div>
