    ...
    <div className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="flex items-center gap-6 mb-12 p-8 bg-navy rounded-xl">
        <div className="w-20 h-20 rounded-full border-2 border-yellow-bb flex items-center justify-center flex-shrink-0">
          <span className="font-['Poppins'] font-bold text-yellow-bb text-2xl leading-none tracking-wide">BB</span>
        </div>
        <div>
          <p className="font-['Poppins'] font-bold text-white text-xl mb-1 tracking-wide">Bahri Budak</p>
