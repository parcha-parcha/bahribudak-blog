...
<a
  ...
  download
  style={{display:'inline-block',marginTop:'1rem',padding:'0.75rem 1.5rem',background:'#1a3a5c',color:'#ffffff',fontWeight:'600',borderRadius:'6px',textDecoration:'none'}}
>
  ⬇ Proses Diyagramını İndir (PDF)
</a>
