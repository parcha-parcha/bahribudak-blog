...
<div className="flex justify-center my-10">
  <a
    ...
    download
    className="inline-flex items-center bg-[#111315] text-white font-semibold px-8 py-4 rounded-lg hover:bg-[#1A1F24] transition-colors text-base"
  >
  ...
  <table className="min-w-full border-collapse text-sm">
    ...
    <tbody>
      <tr className="bg-white">
        ...
        <td className="border border-slate-300 px-4 py-3 align-top bg-[#F8E4DC] font-semibold text-[#111315]">Parti Başına<br />🟢 250.5 $ KAZANÇ<br />(% 58 Tasarruf)</td>
      </tr>
      <tr className="bg-[#F5F7FA]">
        ...
        <td className="border border-slate-300 px-4 py-3 align-top bg-[#F8E4DC] font-semibold text-[#111315]">Parti Başına<br />🟢 226.0 $ KAZANÇ<br />(% 58 Tasarruf)</td>
      </tr>
      <tr className="bg-white">
        ...
        <td className="border border-slate-300 px-4 py-3 align-top bg-[#F8E4DC] font-semibold text-[#111315]">Parti Başına<br />🟢 191.0 $ KAZANÇ<br />(% 57 Tasarruf)</td>
      </tr>
    </tbody>
  </table>
</div>
