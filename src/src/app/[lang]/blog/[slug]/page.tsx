...
export default async function PostPage({ params }: PostPageProps) {
  ...
  return (
    <article className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="mb-6">
        <span
          className="cat-badge text-white text-xs"
      ...
      <div className="mt-16 bg-navy text-white rounded-xl2 p-8 flex items-start gap-6">
        ...
        <div>
          ...
          <a
            ...
            className="text-yellow-bb text-sm font-bold hover:underline"
          >
      ...
      <div className="mt-10">
        <Link
          href={`/${lang}/blog`}
          className="inline-flex items-center gap-2 text-sm font-bold text-navy hover:text-navy-light transition-colors"
        >
